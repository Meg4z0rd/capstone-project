  ...
  <div className="min-h-screen bg-neutral-50 flex flex-col">
    <header className="w-full bg-white border-b border-neutral-200 px-6 py-4">
      <div className="max-w-5xl mx-auto">
        <Link
          to="/"
          className="text-xl font-medium text-neutral-900 no-underline"
        >
              ...
              <div className="flex flex-col gap-1 mt-0.5">
                <div className="flex gap-1">
                  {[1, 2, 3, 4].map((i) => (
                    <div
                      key={i}
                      className={`h-1 flex-1 rounded-full transition-all duration-300 ${i <= strength ? strengthColor[strength] : "bg-neutral-200"}`}
                    />
                  ))}
                </div>
                <p
                  className={`text-xs font-medium ${strength <= 1 ? "text-red-400" : strength === 2 ? "text-amber-500" : strength === 3 ? "text-primary" : "text-green-500"}`}
                >
