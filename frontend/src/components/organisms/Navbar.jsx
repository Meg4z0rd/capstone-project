          ...
          {isLoggedIn ? (
            <div className="relative">
              ...
              <button
                ...
                className="flex items-center gap-2 pl-1.5 pr-3 py-1.5 rounded-pill border border-neutral-200 hover:border-primary transition-all duration-200 cursor-pointer bg-white"
              >
                <UserAvatar user={user} size="sm" />
                <span className="text-sm font-medium text-neutral-900 max-w-[110px] truncate">
                  {user?.name?.split(' ')[0] ?? user?.email ?? 'Akun'}
                </span>
              </button>
                  ...
                  <div className="absolute right-0 mt-2 w-60 bg-white border border-neutral-200 rounded-2xl shadow-lg z-50 overflow-hidden">
                    ...
                    <div className="py-1">
                      <Link to="/profile" onClick={() => setDropdownOpen(false)}
                        className="flex items-center gap-2.5 px-4 py-2.5 text-sm text-neutral-700 hover:bg-neutral-50 transition-colors no-underline">
                      ...
                      <Link to="/analysis" onClick={() => setDropdownOpen(false)}
                        className="flex items-center gap-2.5 px-4 py-2.5 text-sm text-neutral-700 hover:bg-neutral-50 transition-colors no-underline">
